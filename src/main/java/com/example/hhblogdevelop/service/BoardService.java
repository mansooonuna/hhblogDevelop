...
import com.example.hhblogdevelop.repository.BoardRepository;
...
public class BoardService {
    ...
    public BoardFileResponseDto findById(Long id) throws Exception {
        return new BoardFileResponseDto(boardRepository.findById(id).get());
    }
...
//    }
    ...
    public boolean uploadFile(MultipartHttpServletRequest multiRequest, Long boardId) throws Exception {
        ...
        while (itr.hasNext()) {
            ...
            if (fileSize > 0) {
                ...
                resultList.add(boardRepository.save(boardFile).getId());
            }
        }
    ...
    public int updateDeleteYn(Long[] deleteIdList) throws Exception {
        return boardRepository.updateDeleteYn(deleteIdList);
    }

    public int deleteBoardFileYn(Long[] boardIdList) throws Exception {
        return boardRepository.deleteBoardFileYn(boardIdList);
    }
}